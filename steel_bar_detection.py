...
def show_original_red_point(img_original,candidate_center):
    ...
    cv2.putText(img_original, "Generated center points", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
...
def show_green_box(img_original,candidate_center,group_clustering):
    ...
    cv2.putText(img_original, "Cluster the result ", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
...
def show_clustering_red_point(img_original,center_cluster):
    ...
    cv2.putText(img_original, "clustered Final Steel Count: " + str(len(center_cluster)), (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
